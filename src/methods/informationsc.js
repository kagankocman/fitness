...
export function Informationsc() {
    ...
    return (
        <Box sx={{ mt: '5%', display: 'flex' }}>
            <Box style={{ backgroundColor: '#e8f1ff', width: '300px', height: '400px', display: 'flex', flexDirection: 'column', alignItems: 'center' }} sx={{ ml: '5%', mt: '3%' }}>
                { }
            ...
            <Box style={{ backgroundColor: '#e8f1ff', width: '650px', height: '500px' }} sx={{ ml: '7%', mr: '5%' }} >
                ...
                <Button
                    ...
                    sx={{ marginTop: '30px', marginLeft: '140px', bgcolor: '#468bf2', color: 'black' }}
                >
                    Update Password
                </Button>
                <Button
                    ...
                    sx={{ marginTop: '30px', marginLeft: '30px', bgcolor: '#468bf2', color: 'black' }}
                >
                    Update Information
                </Button>
            </Box>
